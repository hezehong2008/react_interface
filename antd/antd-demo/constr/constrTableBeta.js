...
const reqUrl="/platform/constr/beta";
const addUrl="/platform/constr/betaAdd";
const deleteUrl="/platform/constr/betaDelete";
const exeUrl="/platform/constr/betaExe";
const exeRel="/platform/constr/betaExeResult";
const pollInterval=60000;

class ConstrTableBeta extends React.Component {
    constructor(props) {
        super(props);
        this.columns = [{
            title: 'designId',
...
export default ConstrTableBeta;